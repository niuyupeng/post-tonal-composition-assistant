...
For the controlled comparison, aggregate values are computed over all 2,000 test conditions and paired per-item records are retained for mean differences, win--tie--loss rates, and nonparametric bootstrap confidence intervals. No confidence interval is reported until it has been computed from those saved records.
