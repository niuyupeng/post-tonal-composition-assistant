...
The generator is a causal Transformer \citep{vaswani2017attention} with six layers, hidden dimension 384, six attention heads, GELU feed-forward blocks of width $4d$, learned positional embeddings, pre-normalization, and dropout 0.1. The training objective is teacher-forced negative log likelihood over the unmasked score-body labels:
\begin{equation}
...
MusicXML export creates the requested number of score parts and measures, pads empty trailing measures, and removes events outside the requested span \citep{musicxml2021spec}. Success is recorded separately for structural parsing, requested measure count, and requested part count.
