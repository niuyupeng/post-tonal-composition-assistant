...
This blinded package contains 20 score-level MusicXML examples generated by one fixed score-generation configuration. Every part has the requested number of measures, and the requested part count has been verified. Generator identity and automatic metric values are withheld from raters.
